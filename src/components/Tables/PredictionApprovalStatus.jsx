...
import ApprovalStatusModal from "../Admin/Modals/ApprovalStatusModal";
...
class PredictionApprovalStatusTable extends Component {
  ...
  rowClicked = (rowData) => {
    ...
    this.setState({ modalData: rowData.data, modalShow: true });
  };

  modalClosed = () => {
    this.setState({ modalData: {}, modalShow: false });
  };
